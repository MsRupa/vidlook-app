// ============================================
// SPONSORED VIDEO - Update these values manually for promotions
// This video will always appear at the top of the feed
// ============================================
export const SPONSORED_VIDEO_ID = 'dQw4w9WgXcQ'; // Replace with your sponsored video ID
export const SPONSORED_VIDEO_EARN_TEXT = 'Earn 5 $VIDEO per minute'; // Customize this text for each sponsored video
