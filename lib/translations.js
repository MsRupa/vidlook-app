...
export const translations = {
  ...
  es: {
    ...
    convert: {
      ...
      conversionsStartDate: 'Las conversiones comenzarán en abril de 2026',
  ...
  th: {
    ...
    convert: {
      ...
      conversionsStartDate: 'การแลกเปลี่ยนจะเริ่มในเดือนเมษายน 2026',
  ...
  ja: {
    ...
    convert: {
      ...
      conversionsStartDate: '交換は2026年4月に開始予定',
      history: '交換履歴',
