...
export const translations = {
  en: {
    ...
    profile: {
      ...
      faq4Answer: 'VidLook generates revenue from YouTube ad views and shares a portion of that revenue with our users through $VIDEO tokens. The more you watch, the more you earn - it\'s that simple!',
  ...
  es: {
    ...
    profile: {
      ...
      faq4Answer: 'VidLook genera ingresos de los anuncios de YouTube y comparte una parte de esos ingresos con nuestros usuarios a través de tokens $VIDEO. ¡Cuanto más mirás, más ganás - así de simple!',
  ...
  th: {
    ...
    profile: {
      ...
      faq4Answer: 'VidLook สร้างรายได้จากโฆษณา YouTube และแบ่งปันส่วนหนึ่งของรายได้นั้นให้กับผู้ใช้ผ่านโทเคน $VIDEO ยิ่งดูมาก ยิ่งได้มาก - ง่ายแค่นี้!',
