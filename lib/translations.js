...
export const translations = {
  en: {
    ...
    convert: {
      ...
      conversionsStartDate: 'Conversions will begin soon. We\'ll notify you.',
  ...
  es: {
    ...
    convert: {
      ...
      conversionsStartDate: 'Las conversiones comenzarán pronto. Te avisaremos.',
  ...
  th: {
    ...
    profile: {
      ...
      faq4Answer: 'VidLook สร้างรายได้จากโฆษณาของบุคคลที่สามที่แสดงระหว่างวิดีโอ และแบ่งรายได้ส่วนหนึ่งให้ผู้ใช้ผ่านโทเค็น $VIDEO ยิ่งคุณดูมากเท่าไหร่ เราก็ยิ่งได้มากขึ้นด้วยกัน - ง่ายๆ แค่นั้น!',
    ...
    convert: {
      ...
      conversionsStartDate: 'การแลกจะเริ่มเร็วๆ นี้ เราจะแจ้งให้คุณทราบ',
  ...
  ja: {
    ...
    profile: {
      ...
      faq4Answer: 'VidLookは動画間に表示されるサードパーティ広告から収益を得て、その広告収益の一部を$VIDEOトークンとしてユーザーに還元しています。視聴すればするほど、私たちは一緒により多くを獲得できます - とてもシンプルです！',
    ...
    convert: {
      ...
      conversionsStartDate: '交換はまもなく開始されます。通知します。',
      history: '交換履歴',
