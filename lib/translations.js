...
export const translations = {
  en: {
    ...
    convert: {
      ...
      comingSoon: '🚀 Conversions launching April 2026! Keep earning $VIDEO — redeem for WLD soon!'
    },
  ...
  es: {
    ...
    convert: {
      ...
      comingSoon: '🚀 ¡Conversiones disponibles en Abril 2026! Seguí ganando $VIDEO — ¡canjealo por WLD pronto!'
    },
  ...
  th: {
    ...
    convert: {
      ...
      comingSoon: '🚀 เปิดแลกเปลี่ยนเมษายน 2026! สะสม $VIDEO ต่อไป — แลกเป็น WLD ได้เร็วๆ นี้!'
    },
  ...
  ja: {
    ...
    convert: {
      ...
      comingSoon: '🚀 2026年4月に交換開始！$VIDEOを貯め続けよう — まもなくWLDに交換できます！'
    },
