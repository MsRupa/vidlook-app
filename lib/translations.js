...
export const translations = {
  en: {
    ...
    profile: {
      ...
      faq3Answer1: 'Sponsored videos:',
      faq3Answer2: '5 $VIDEO per minute',
      faq3Answer3: 'Regular videos:',
      faq3Answer4: '2 $VIDEO per minute',
  ...
  es: {
    ...
    profile: {
      ...
      faq3Answer1: 'Videos patrocinados:',
      faq3Answer2: '5 $VIDEO por minuto',
      faq3Answer3: 'Videos regulares:',
      faq3Answer4: '2 $VIDEO por minuto',
  ...
  th: {
    ...
    profile: {
      ...
      faq3Answer1: 'วิดีโอสปอนเซอร์:',
      faq3Answer2: '5 $VIDEO ต่อนาที',
      faq3Answer3: 'วิดีโอทั่วไป:',
      faq3Answer4: '2 $VIDEO ต่อนาที',
